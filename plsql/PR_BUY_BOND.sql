...
BEGIN
  ...
  --   BUY_QTY    -- 매수수량
  --   BOND_IR    -- 표면이자율
  --   EVENT_TYPE -- Event 종류(1.매수, 2.매도, 3.금리변동, 4.손상, 5.회복)
  ...
  ----------------------------------------------------------------------------------------------------
  T_EVENT_INFO.FUND_CODE  := I_BUY_INFO.FUND_CODE;   -- 펀드코드(채권잔고의PK)
  T_EVENT_INFO.BOND_CODE  := I_BUY_INFO.BOND_CODE;   -- 종목코드(채권잔고의PK)
  T_EVENT_INFO.BUY_DATE   := I_BUY_INFO.TRD_DATE;    -- 매수일자(채권잔고의PK)
