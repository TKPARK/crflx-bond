...
BEGIN
  ...
  ELSIF T_ORGN_BOND_TRADE.GOODS_BUY_SELL_SECT = '2' THEN
    ...
    T_BOND_BALANCE.TTRM_BOND_INT   := T_BOND_BALANCE.TTRM_BOND_INT + T_ORGN_BOND_TRADE.TTRM_BOND_INT;                                 -- 당기채권이자
    ...
    T_BOND_BALANCE.DRT_SELL_QTY    := T_BOND_BALANCE.DRT_SELL_QTY - T_ORGN_BOND_TRADE.TRD_QTY;                                        -- 직매도수량
