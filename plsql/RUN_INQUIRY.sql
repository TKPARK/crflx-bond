...
--DELETE FROM EVENT_RESULT_NESTED_S WHERE BOND_CODE = 'KR_TKPARK';
--DELETE FROM BOND_BALANCE WHERE BOND_CODE = 'KR_TKPARK';
--DELETE FROM BOND_TRADE WHERE BOND_CODE = 'KR_TKPARK';
